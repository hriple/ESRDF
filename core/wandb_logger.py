...
class WandbLogger:
	...
	# 这段代码定义了一个名为 log_eval_data 的函数，它是用于记录评估数据到一个表格中，通常这个表格
    # def log_eval_data(self, fake_img, sr_img, hr_img, psnr=None, ssim=None):
    def log_eval_data(self, fake_img, sr_img, add_img, hr_img, psnr=None, ssim=None):
        """
