...
def up_pre_cnn(hr_img, upscale_factor):
    ...
    model_path = '/newHome/S2_HHH/gitte/ddpm_our/data/pre_model/8_times_model_20250321-192202_L1/model.pth'  # 训练好的模型路径
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out', '-o', type=str,
                        default='/newHome/S2_HHH/gitte/ddpm_our/dataset/test_1200')
