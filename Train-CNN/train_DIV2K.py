...
def main():
    ...
    parser.add_argument('--hr_dir', type=str, default='/newHome/S2_HHH/zzzz_Pixel_predictor/data/DIV2k/train_40_160/hr_160')
    parser.add_argument('--valid_dir', type=str, default='/newHome/S2_HHH/srdiff_data/Div2K/test/HR')
    # # 新增预训练模型加载参数
    ...
    args.results = os.path.join(args.results, f'DIV2K_{args.low_size}_{args.high_size}_model_{timestamp}')
    os.makedirs(args.results, exist_ok=True)
    
    args.model_save = os.path.join(args.model_save, f'DIV2K_{args.low_size}_{args.high_size}_model_{timestamp}')
