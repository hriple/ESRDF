...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', '-p', type=str,
                        default='/newHome/S2_HHH/srdiff_data/Div2K/test/HR')
    parser.add_argument('--out', '-o', type=str,
                        default='/newHome/S2_HHH/zzzz_Pixel_predictor/data/DIV2k/test')
    ...
    resample_map = {'bilinear': Image.BILINEAR, 'bicubic': Image.BICUBIC, 'nearest': Image.NEAREST}
